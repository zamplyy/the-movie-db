...
const MovieList = (props: MovieListProps) => {
  ...
  return (
    <ul
      role="list"
      className="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8 mb-6"
    >
      ...
      <div className="relative bg-gray-50 overflow-hidden min-h-screen">
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl sm:tracking-tight md:text-6xl md:tracking-tight mb-6">
            ...
            {movies?.length === 0 ? (
              <>
                <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                  Tryck på knappen för att hämta de populäraste 100 filmerna
                  just nu.
                </p>
